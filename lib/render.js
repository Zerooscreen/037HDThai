...
const SITE_NAME = '037HDThai';
const DEFAULT_TITLE = '037HDThai | เว็บข้อมูลหนังใหม่ ตัวอย่างหนัง รีวิวเรื่องย่อ และรอบฉายอัปเดต 2026';
const DEFAULT_DESC = 'อัปเดตข้อมูลหนังใหม่ ซีรีส์ดัง 2026 เช็คเรตติ้ง เรื่องย่อ ตัวอย่างหนัง และข้อมูลนักแสดงแบบจัดเต็ม ค้นหาสะดวก ดูได้บนมือถือและคอมพิวเตอร์ที่ 037HDThai';
...
function head({ title, description, url, image, type = 'website', robots = 'index, follow' }) {
  ...
  return `
    ...
    <!-- ==================== MONETAG SCRIPT (HEAD) ==================== -->
    <!-- Tempelkan script global/head dari Monetag di sini jika ada -->
    <!-- <script src="https://kulmiurw.net/tag.min.js" data-zone="XXXXXX" async data-cfasync="false"></script> -->
  `;
}
...
function monetagBodyScript() {
  return `
    <!-- ==================== MONETAG SCRIPT (BODY / FOOTER) ==================== -->
    <!-- Tempelkan script OnClick / In-Page Push Monetag di sini jika ada -->
  `;
}
